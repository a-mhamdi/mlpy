...
@app.cell
def _(mo):
    degree = mo.ui.slider(1, 10, 1, 4)
    degree
    return (degree,)


@app.cell
def _(PolynomialFeatures, X_1, degree):
    poly_reg = PolynomialFeatures(degree=degree.value)
...
@app.cell
def _(LinearRegression, X_poly, y):
