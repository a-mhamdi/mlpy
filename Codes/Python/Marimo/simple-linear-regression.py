...
@app.cell
def _(mean_absolute_percentage_error, y_pred, y_test):
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""$$\hat{\theta} \;=\; \displaystyle\dfrac{\displaystyle\sum_{i=0}^{n-1} y_i x_i}{\displaystyle\sum_{i=0}^{n-1} x_i^2}$$""")
    return
